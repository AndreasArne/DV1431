...
public class DoQuizzFragment extends Fragment {
    ...
    public static final DoQuizzFragment newInstance(Question q, int questionIndex, int nQuestions)
    {

        DoQuizzFragment f = new DoQuizzFragment();
...
//    doQuizRadioGroup
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Set question text
        view = inflater.inflate(R.layout.doquizz_fragment, container, false);
