...
/**
 * Created by mihai on 2014-12-08.
 */
public class EditQuestion extends Activity {
     ...
     */
            ...
            builder.setMessage("Enter answer:")
                    .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            else Toast.makeText(EditQuestion.this, "Too many answers, delete one first", Toast.LENGTH_LONG).show();
                        }
                    })
        ...
        private void refreshAnswerListU() {
            if (this.answers.size() > MAX_NR_ANSWERS) {
                Toast.makeText(EditQuestion.this, "Too many answers, delete one first", Toast.LENGTH_LONG).show();
            }
            else {
    ...
    public void onBackPressed() {
        ...
        Intent resultIntent = new Intent();
        resultIntent.putExtra("Question", defaultQuestion);
